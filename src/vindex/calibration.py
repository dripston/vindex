...
CALIBRATION_TABLE: dict[str, dict[str, CalibratedThreshold]] = {
    "sentence-transformers/all-MiniLM-L6-v2": {
        "en": CalibratedThreshold(0.8629738688468933, 0.65, 0.5, n_cases=10, warnings=()),
        "hi": CalibratedThreshold(
            0.10077689588069916, 0.631578947368421, 0.5263157894736842, n_cases=9, warnings=()
        ),
        "hinglish": CalibratedThreshold(0.35428088903427124, 0.75, 0.6, n_cases=10, warnings=()),
    },
    "sentence-transformers/LaBSE": {
        ...
        "hinglish": CalibratedThreshold(0.4422089755535126, 0.75, 0.65, n_cases=10, warnings=()),
    },
    "intfloat/multilingual-e5-base": {
        "en": CalibratedThreshold(0.8811413049697876, 0.9, 0.5, n_cases=10, warnings=()),
        "hi": CalibratedThreshold(
            0.8806519508361816, 0.631578947368421, 0.47368421052631576, n_cases=9, warnings=()
        ),
        "hinglish": CalibratedThreshold(0.8469548225402832, 0.75, 0.5, n_cases=10, warnings=()),
    },
    MURIL_MODEL_NAME: {
        "en": CalibratedThreshold(
            0.9957686066627502,
        ...
        "hinglish": CalibratedThreshold(0.9907472133636475, 0.6, 0.5, n_cases=10, warnings=()),
    },
    "sentence-transformers/paraphrase-multilingual-mpnet-base-v2": {
        "en": CalibratedThreshold(0.8324964046478271, 0.85, 0.5, n_cases=10, warnings=()),
        "hi": CalibratedThreshold(
            0.8738334774971008, 0.7368421052631579, 0.47368421052631576, n_cases=9, warnings=()
        ),
        "hinglish": CalibratedThreshold(0.41423243284225464, 0.8, 0.7, n_cases=10, warnings=()),
    },
}
